...
class A2AHandler:
    ...
    async def handle(self, plain_text: str) -> A2AResponse:
        ...
        # Build the A2A response using Pydantic models
        a2a_response = self._build_a2a_response(text_content)
    ...
    def _build_a2a_response(self, text_content: str) -> A2AResponse:
        """
